...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo esc_url( get_template_directory_uri() ); ?>/css/artist.css">
        ...
        <link href="https://fonts.googleapis.com/css?family=Anton|Hind+Guntur|Source+Sans+Pro|Inconsolata|Poppins|Fjalla+One|Montserrat|Yanone+Kaffeesatz|Passion+One|Slabo+27px|Abril+Fatface|Domine|Scope+One|Frank+Ruhl+Libre|Great+Vibes|Satisfy|Palanquin" rel="stylesheet">
        ...
        <link rel="stylesheet" href="https://npmcdn.com/leaflet@0.7.7/dist/leaflet.css" />
                <link rel="stylesheet" href="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/css/litebox.css">
